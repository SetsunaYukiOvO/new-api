...
const UsersTable = (usersData) => {
  ...
  const handleEnableDisableConfirm = ({ banInviter } = {}) => {
    const extraParams = banInviter ? { ban_inviter: true } : {};
    manageUser(modalUser.id, enableDisableAction, modalUser, extraParams);
